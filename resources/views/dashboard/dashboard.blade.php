    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">{{ $greet }} Selamat datang, {{ Session::get('name') }}!</h3>
                        <ul class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <div> <span class="d-block">Karyawan Baru</span> </div>
                                ...
                                <p class="mb-0">Keseluruhan Karyawan 218</p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <div> <span class="d-block">Penghasilan</span> </div>
                                ...
                                <p class="mb-0">Bulan Sebelumnya <span class="text-muted">$1,15,852</span></p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <div> <span class="d-block">Pengeluaran</span> </div>
                                ...
                                <p class="mb-0">Bulan Sebelumnya <span class="text-muted">$7,500</span></p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <div> <span class="d-block">Keuntungan</span> </div>
                                ...
                                <p class="mb-0">Bulan Sebelumnya <span class="text-muted">$1,42,000</span></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="stats-list">
                                <div class="stats-info">
                                    <p>Hari ini cuti <strong>4 <small>/ 65</small></strong></p>
                                    <div class="progress">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: 31%" aria-valuenow="31" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="stats-info">
                                    <p>Faktur Tertunda <strong>15 <small>/ 92</small></strong></p>
                                    <div class="progress">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 31%" aria-valuenow="31" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="stats-info">
                                    <p>Proyek yang Telah Selesai <strong>85 <small>/ 112</small></strong></p>
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 62%" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="stats-info">
                                    <p>Tiket Terbuka <strong>190 <small>/ 212</small></strong></p>
                                    <div class="progress">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: 62%" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="stats-info">
                                    <p>Tiket Tertutup <strong>22 <small>/ 212</small></strong></p>
                                    <div class="progress">
                ...
                <div class="col-md-12 col-lg-6 col-xl-4 d-flex">
                    <div class="card flex-fill">
                        <div class="card-body">
                            <h4 class="card-title">Statistik Tugas</h4>
                            ...
                            <div>
                                <p><i class="fa fa-dot-circle-o text-purple mr-2"></i>Tugas yang sudah selesai <span class="float-right">166</span></p>
                                <p><i class="fa fa-dot-circle-o text-warning mr-2"></i>Tugas yang Sedang Berjalan <span class="float-right">115</span></p>
                                <p><i class="fa fa-dot-circle-o text-success mr-2"></i>Tugas yang Ditunda <span class="float-right">31</span></p>
                                <p><i class="fa fa-dot-circle-o text-danger mr-2"></i>Tugas Tertunda <span class="float-right">47</span></p>
                                <p class="mb-0"><i class="fa fa-dot-circle-o text-info mr-2"></i>Tinjau Tugas <span class="float-right">5</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-6 col-xl-4 d-flex">
                    <div class="card flex-fill">
                        <div class="card-body">
                            <h4 class="card-title">Hari ini Absen <span class="badge bg-inverse-danger ml-2">5</span></h4>
                            <div class="leave-info-box">
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col-6">
                                        <h6 class="mb-0">4 Sep 2019</h6> <span class="text-sm text-muted">Tanggal Cuti</span> </div>
                                    <div class="col-6 text-right"> <span class="badge bg-inverse-danger">Tertunda</span> </div>
                                </div>
                            </div>
                            <div class="leave-info-box">
                                <div class="media align-items-center">
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col-6">
                                        <h6 class="mb-0">4 Sep 2019</h6> <span class="text-sm text-muted">Tanggal Cuti</span> </div>
                                    <div class="col-6 text-right"> <span class="badge bg-inverse-success">Disetujui</span> </div>
                                </div>
                            </div>
                            <div class="load-more text-center"> <a class="text-dark" href="javascript:void(0);">Muat Lebih Banyak</a> </div>
                        </div>
                    </div>
                </div>
            </div>
