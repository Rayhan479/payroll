            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_expense"><i class="fa fa-plus"></i> Tambahkan Pengeluaran</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                ...
                <div class="row filter-row">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">  
                        <div class="form-group form-focus">
                            ...
                            <label class="focus-label">Ke</label>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Item</th>
                                    <th class="purchase_from">Pembelian Dari</th>
                                    <th class="purchase_date">Tanggal Pembelian</th>
                                    <th class="purchased_by">Dibeli oleh</th>
                                    <th class="amount">Jumlah</th>
                                    <th class="paid_by">Dibayar oleh</th>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown action-label">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-danger"></i> Tertunda</a>
                                                <a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-success"></i> Disetujui</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-right">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambahkan Pengeluaran</h5>
