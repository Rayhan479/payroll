        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Slip gaji</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Item Penggajian</a></li>
                            <li class="breadcrumb-item active">Item Penggajian</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tab_additions">Penambahan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_overtime">Lembur</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_deductions">Pengurangan</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane show active" id="tab_additions">
                    ...
                    <div class="text-right mb-4 clearfix">
                        <button class="btn btn-primary add-btn" type="button" data-toggle="modal" data-target="#add_addition"><i class="fa fa-plus"></i> Tambahkan Penambahan</button>
                    </div>
                    <!-- /Add Addition Button -->
                            ...
                            <table class="table table-hover table-radius">
                                <thead>
                                    <tr>
                                        <th>Nama</th>
                                        <th>Kategori</th>
                                        <th>Jumlah Standar/Satuan</th>
                                        <th class="text-right">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th>Jumlah saldo cuti</th>
                                        <td>Remunerasi bulanan</td>
                                        <td>$5</td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <th>Tunggakan gaji</th>
                                        <td>Remunerasi tambahan</td>
                                        <td>$8</td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
